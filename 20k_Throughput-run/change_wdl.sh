...
sed -i 's|samtools |${tool_path}/samtools/samtools |g' *.wdl
sed -i 's|seq_cache_populate\.pl |${tool_path}/samtools/misc/seq_cache_populate\.pl |g' *.wdl
...
zip warp.zip *.wdl
rm -rf [A-V]*.wdl
mv WholeGenomeGermlineSingleSample_*.wdl WholeGenomeGermlineSingleSample.wdl
...
#sleep 10 
#WFID=`ls -tr /fastdata/01/genomics/cromwell/cromwell-slurm-exec/WholeGenomeGermlineSingleSample/ | tail -n1`
